...
extend(MapnikTilesProvider.prototype, TilesProvider.prototype, {
    ...
    _newRenderer : function(key) {
        ...
        return Promise.resolve().then(function() {
            if (!that._loader) {
                var loader = that.options.renderers //
                        || that.options.getRenderer //
                        || that.options.rendererLoader //
                        || that.options.loader;
                if (!loader) {
                ...
                if (typeof loader === 'function') {
                    ...
                    that._loader = function(key) {
                        return loader.getRenderer(key);
                    }
                }
            }
            return that._loader(key);
        });
    },
