...
MapnikRenderer.prototype = {
    ...
    renderVectorTile : function(options) {
        var that = this;
        return that._withMap(options, function(params) {
            var vtile = params.vtile || params.tile;
            if (!vtile) {
    ...
    _loadMap : function(options) {
        ...
        if (!that.__loadMap) {
            ...
            .then(function() {
                ...
                var bufferSize = that._getBufferSize();
    ...
    _getBufferSize : function() {
        var mml = this.options.mml || {};
        var bufferSize = mml.bufferSize || this.options.bufferSize;
        return bufferSize;
    },
    ...
    _withMap : function(options, action) {
        ...
        return that._withPromise('__withMap', function() {
            return that._loadMap(options).then(function(map) {
                var z = +options.z;
                var x = +options.x;
                var y = +options.y;
